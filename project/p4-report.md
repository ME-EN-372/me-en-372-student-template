...
<Named quantity of interest, evaluated away from a singularity, across at least
three systematically refined meshes. Table or plot, plus the relative change.>

## FEA vs. hand calculation

**State your agreement tolerance before you compare, and justify it.**

| Quantity | Hand | FEA | Difference |
|---|---|---|---|

<Then diagnose: boundary condition, mesh, formula, material, or a real geometry
effect the closed-form solution cannot capture.>
